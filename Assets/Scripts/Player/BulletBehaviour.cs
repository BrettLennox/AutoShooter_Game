...
public class BulletBehaviour : MonoBehaviour, IKillable
{
    ...
    void Update()
    {
        ...
        //if (Target == null || !Target.gameObject.activeInHierarchy) //if Target == null and Target is not active in heirarchy => performs ChangeTarget function with EnemyTracker.ClosestEnemy function return
        //{
        //    ChangeTarget(EnemyTracker.ClosestEnemy(transform).transform);
        //}
    ...
    //private void ChangeTarget(Transform target) //Changes Target to the passed in GameObject
    //{
    //    Target = target;
    //}
